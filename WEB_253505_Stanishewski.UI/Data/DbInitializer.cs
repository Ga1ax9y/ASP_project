        ...
        public static async Task SeedData(WebApplication app)
        {
            ...
            if (!context.Games.Any())
            {
                ...
                var games = new List<Game>
                {
                    ...
                    new Game { Title="Red Dead Redemption 2",Description="Супер игра",Price=80, Image=$"{baseUrl}/Images/Red_Dead_Redemption_2.jpg",Category=categories.Find(c=>c.NormalizedName.Equals("role-playing")), CategoryId = categories.Find(c => c.NormalizedName.Equals("role-playing"))?.Id ?? 0},
                    ...
                    new Game { Title="Grand Theft Auto VI",Description="Возможно Крутая игра",Price=135, Image=$"{baseUrl}/Images/GTA_6.jpeg",Category=categories.Find(c=>c.NormalizedName.Equals("action")),CategoryId=categories.Find(c => c.NormalizedName.Equals("action"))?.Id ?? 0},
                    new Game { Title="Hearts of Iron IV",Description="Злая игра",Price=15, Image=$"{baseUrl}/Images/Hearts_of_Iron_IV.png",Category=categories.Find(c=>c.NormalizedName.Equals("strategy")),CategoryId=categories.Find(c => c.NormalizedName.Equals("strategy"))?.Id ?? 0},
